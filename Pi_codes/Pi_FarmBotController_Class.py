...
class FarmBotController:
    ...
    def print_help(self):
        ...
        print("  X####     - Move relative steps (e.g., X1000, X-500)") 
        print("  P25       - Move to 25% position") #Absolute Positions (Later Changed depending on actual positional matrix of farm)
        print("  P50       - Move to 50% position") 
        print("  P75       - Move to 75% position")
        print()
        print("System Commands:")
        print("  H         - Run homing sequence")
