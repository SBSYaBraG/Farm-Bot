...
|------------------|----------|-------------|
| Movement         | `X####/Y####/Z####`    | Move relative steps (`X3200`, `Y-500`) |
|                  | `PX/PY/PZ` | Absolute Positioning of Desired Axis
|                  | `PX25`     | Go to 25% absolute position |
|                  | `PX50`     | Go to 50% absolute position |
|                  | `PX75`     | Go to 75% absolute position |
| System           | `HX/HY/HZ` | Home Individual Axes
|                  | `H/HALL`   | Run homing sequence |
