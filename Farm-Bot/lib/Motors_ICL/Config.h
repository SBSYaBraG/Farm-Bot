 ...
 * 
 * 4-motor system: X(2 motors), Y(1 motor), Z(1 motor)
 * Each axis has independent control and limit switches
 * All active motors have individual ALM monitoring
 */
...
// -------------------- Z-AXIS PINS (5 active) --------------------
#define Z_PUL_PIN 42
#define Z_DIR_PIN 44
#define Z_ENA_PIN 40
#define Z_LIMIT_PIN 22
#define ALM_ZL_PIN 33     // Active Z motor

// Reserved for the second Z motor if the dual-Z setup is restored.
